...
while True:
    ...
    if face_extractor(frame) is not None:
        ...
        file_name_path = '/root/Desktop/a/face' + str(count) + '.jpg'
...
while True:
    ...
    try:
        ...
        if confidence > 80:
            ...
            cv2.putText(image, "Hey", (250, 450), cv2.FONT_HERSHEY_COMPLEX, 1, (0,255,0), 2)
